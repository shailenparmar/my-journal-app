...
const PASSAGES = {
  easy: [
    ...
    "A hare was making fun of a tortoise for being so slow. The tortoise challenged him to a race.",
    "A boy cried wolf so many times that when a wolf really came, nobody believed him.",
    "A dog and his shadow crossed a bridge. He saw his reflection and thought it was another dog with meat.",
    "An oak tree mocked a reed for bending in the wind. Then a great storm came and tested them both.",
    "A fox could not reach the grapes and said they were probably sour anyway.",
    "Two goats met on a narrow bridge. Neither would give way to the other.",
    "A cat put a bell around her neck so the mice could hear her coming.",
    "A thirsty crow found a pitcher with water at the bottom. He dropped stones in to raise the level.",
    "The mice held a meeting to decide how to be safe from the cat.",
    "A man had a goose that laid golden eggs. He wanted all the gold at once.",
  ],
  medium: [
    ...
    "I have always held that a little knowledge is a dangerous thing.",
